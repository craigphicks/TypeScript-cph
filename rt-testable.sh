...
myMaxLinesOut=300000 myDebug=0 myDebugLevel=1 myDisableInfer=0 gulp runtests -t="_caxnc-(and|if|array|bi|block|cem|enum|exclamation|ez|fn|if|let|literal|lt|parens|prop|rhsAssign|rp|typeof|typeUn)"
