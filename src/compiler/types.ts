namespace ts {
    ...
    export interface TypeChecker {
        ...
        /* @internal */ forEachType<T>(type: Type, f: (t: Type) => T | undefined): T | undefined;
        /* @internal */ getTypeFacts(type: Type, ignoreObjects?: boolean): TypeFacts;
        /* @internal */  isTypeRelatedTo(source: Type, target: Type, relation: ESMap<string, RelationComparisonResult>): boolean;
        /* @internal */  getRelations(): {
            subtypeRelation: ESMap<string, RelationComparisonResult>;
            strictSubtypeRelation: ESMap<string, RelationComparisonResult>;
            assignableRelation: ESMap<string, RelationComparisonResult>;
            comparableRelation: ESMap<string, RelationComparisonResult>;
            identityRelation: ESMap<string, RelationComparisonResult>;
            enumRelation: ESMap<string, RelationComparisonResult>;
        }
        /* @internal */  isArrayOrTupleType(type: Type): type is TypeReference;
        /* @internal */  isConstVariable(symbol: Symbol): boolean;
        ...
        /* @internal */ getIntersectionType(types: Type[]): Type;
        /* @internal */ createArrayType(elementType: Type, readonly?: boolean | undefined): Type;
