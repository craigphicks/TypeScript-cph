...
import {
    ConstraintItem,
    ConstraintItemNode,
    ConstraintItemNodeAnd,
    ConstraintItemKind,
    ConstraintItemNodeOp,
    ConstraintItemNodeOr,
    ConstraintItemLeaf,
    ConstraintItemNever,
...
//     cin: Readonly<ConstraintItem>;
//     symbol: Readonly<Symbol>;
//     typeRange: Readonly<RefTypesType>;
//     negate?: boolean; /*refDfltTypeOfSymbol: [RefTypesType | undefined],*/
//     mrNarrow: MrNarrow;
//     depth?: number;
// }): RefTypesType {
//     depth = depth ?? 0;
...
//     refCountOut,
//     depth,
// }: { symbol: Symbol; type: RefTypesType; declaredType?: RefTypesType; cin: ConstraintItem; negate?: boolean | undefined; getDeclaredType: GetDeclaredTypeFn; mrNarrow: MrNarrow; refCountIn?: [number]; refCountOut?: [number]; depth?: number; }): ConstraintItem {
...
//             IDebug.ilog(()=>`andDistributeDivide[in][${depth ?? 0}] constraint: ${s}`);
//         });
//     }
...
//         constraintItem = andDistributeDivide({ symbol, type, cin: constraintItem, getDeclaredType, declaredType: getDeclaredType(symbol), mrNarrow });
//         /////////////////////////
//         if (extraAsserts) {
...
//             if (
//                 !gotType || floughTypeModule.isNeverType(gotType) ||
 ...
 */
// @ts-ignore-error
// type VisitSOPMap = Map<Symbol, RefTypesType>;
// function visitSOP(ciTop: Readonly<ConstraintItem>, visitor: (mapSymbolType: Readonly<VisitSOPMap>) => void, _mrNarrow: MrNarrow, getDeclaredType: GetDeclaredTypeFn): void {
//     function newMap() {
...
//     }
//     function worker(mapref: [Readonly<VisitSOPMap>], ciLeft: Readonly<ConstraintItem>, negate: boolean, aciRight: Readonly<ConstraintItem[]>): void {
...
// export function evalCoverPerSymbol(...args: Parameters<typeof evalCoverPerSymbolV2>): Map<Symbol, RefTypesType> {
...
// function evalCoverForOneSymbol(symbol: Symbol, ciTop: Readonly<ConstraintItem>, getDeclaredType: GetDeclaredTypeFn, mrNarrow: MrNarrow): RefTypesType {
...
// export function testOfEvalTypeOverConstraint(checker: FloughTypeChecker, mrNarrow: MrNarrow): void {
//     type Symtab = Map<Symbol, RefTypesType>;
...
//         {
//             in: {
//                 cin: createFlowConstraintNodeAnd({
//                     constraints: [
...
//         {
//             in: {
//                 cin: createFlowConstraintNodeOr({
//                     constraints: [
//                         createFlowConstraintLeaf(symx, rtttrue),
