...
ls -d tmp
git status
git checkout -f origin-main-booleanArrayFilter
git status
myLogLevel=0 myAssertLevel=1 nouseRcev2=1 hereby runtests --tests="unionOfArrayFilterCall" 
find tests/cases -name "*unionOfArray*"
myLogLevel=0 myAssertLevel=1 nouseRcev2=1 hereby runtests --tests="unionOfArraysFilterCall" 
hereby baseline-accept
ls -l tests/baselines/reference/*
ls -l tests/baselines/reference/
ls -l tests/baselines/reference/*.types
ls -l tests/baselines/local/*.types
whoami
groups
sudo chown node tests/baselines/local/*
ls -l tests/baselines/local/*.types
ls -l tests/baselines/reference/*.types
hereby baseline-accept
chown  --help
sudo chown node:node tests/baselines/reference/*
find tests/baselines/reference -name "*.*"  sudo chown node:node {} \;
find tests/baselines/reference -name "*.*"  -exec sudo chown node:node {} \;
sudo chown node"node -R tests/baselines/reference/ 
sudo chown node:node -R tests/baselines/reference/ 
ls -l tests/baselines/reference/*.types
hereby baseline-accept
myLogLevel=0 myAssertLevel=1 nouseRcev2=0 hereby runtests --tests="unionOfArraysFilterCall" 
myLogLevel=4 myAssertLevel=1 nouseRcev2=0 hereby runtests --tests="unionOfArraysFilterCall" 
myLogLevel=4 myAssertLevel=1 nouseRcev2=0 hereby runtests --tests="unionOfArraysFilterCall" -i
myLogLevel=4 myAssertLevel=1 nouseRcev2=0 hereby runtests --tests="unionOfArraysFilterCall" 
git status 
git status
git add .
git restore  tests/baselines/reference/unionOfArraysFilterCall.*
git status
git checkout HEAD~1  tests/baselines/reference/unionOfArraysFilterCall.*
git checkout HEAD~1  -- tests/baselines/reference/unionOfArraysFilterCall.*
git diff --name-only HEAD~1 -- tests
git checkout HEAD~1  -- tests/baselines/reference/unionOfArraysFilterCall.*
git checkout HEAD~1  -- tests/baselines/reference/
git diff --name-only HEAD~1 -- tests
git status
