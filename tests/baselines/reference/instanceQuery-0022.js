...
//// [instanceQuery-0022.js]
"use strict";
var instanceQuery22a;
(function (instanceQuery22a) {
    class A {
        a = 2;
    }
    class B extends A {
...
})(instanceQuery22a || (instanceQuery22a = {}));
var instanceQuery22b;
(function (instanceQuery22b) {
    ...
    function isInstanceofA(x) {
        return x instanceof A;
    }
    function isInstanceofB(x) {
        return x instanceof B;
    }
    function isInstanceofC(x) {
        return x instanceof C;
    }
    const q = Math.random();
    const x = q < 0.33 ? new A() : q < 0.66 ? new B() : new C(); //  ((instanceof A & A)) | ((instanceof B & B)) | ((instanceof C & C))
...
})(instanceQuery22b || (instanceQuery22b = {}));
(function (instanceQuery22b) {
    const InstanceofObject = Object;
    class A extends InstanceofObject {
        a = 2;
